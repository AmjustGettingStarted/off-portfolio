export const projects = [
  ...
  },
  {
    ...
    description:
      "A dynamic, multi-step bounty creation wizard built with Next.js, React Hook Form, Zod, and shadcn-ui. Features real-time validation, smooth animations, reusable components, and clean JSON output for easy backend integration.",
    imgUrl: "/bountywizard.png",
    link: "https://bounty-creation-vzard.vercel.app/",
    tags: [
      "NextJS",
      "TypeScript",
      "React Hook Form",
